              ...
              return (
                ...
                >
                  ...
                  <div className="w-[320px] sm:w-[480px] h-[520px] sm:h-[520px] relative group perspective-1000">
                    ...
                    <div className="absolute -inset-1 bg-gradient-to-r from-purple-900 via-purple-700 to-purple-900 rounded-2xl opacity-60 group-hover:opacity-90 transition-all duration-500 animate-pulse"></div>
