              ...
              return (
                ...
                >
                  ...
                  <div className="w-[320px] sm:w-[480px] h-[520px] sm:h-[520px] relative group perspective-1000">
                    ...
                    <div className="absolute -inset-1 bg-gradient-to-r from-[#b066cc] via-[#dd87ff] to-[#b066cc] rounded-2xl opacity-60 group-hover:opacity-90 transition-all duration-500 animate-pulse"></div>
              ...
              return (
                <button
                  ...
                  className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full transition-all duration-500 ${
                    isActive
                      ? "bg-gradient-to-r from-[#dd87ff] to-[#b066cc] w-6 sm:w-8 shadow-lg shadow-[#dd87ff]/50"
