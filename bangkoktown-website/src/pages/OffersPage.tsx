  ...
  return (
    <div className="min-h-screen bg-company-neutral relative overflow-hidden">
      ...
      <div className="fixed inset-0 opacity-5 pointer-events-none">
        <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-to-br from-purple-900 to-purple-700 rounded-full blur-3xl animate-pulse"></div>
      </div>
      ...
      {selected && (
        ...
        >
          <button
            style={{ zIndex: 10000 }}
            className="fixed top-6 right-6 w-10 h-10 flex items-center justify-center bg-white/10 hover:bg-purple-500 text-white text-2xl rounded-full transition-colors"
            onClick={(e) => {
              e.stopPropagation();
              setSelected(null);
            }}
